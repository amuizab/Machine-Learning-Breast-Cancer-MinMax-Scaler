# -*- coding: utf-8 -*-
"""Machine Learning breastcancer minmax scaler.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/12uJ_RgSz2DnCiqAd4aR2_jdsGATHPZ_1
"""
...
minmaxscal((data[['f1']]), data, ('f1'))
minmaxscal((data[['f3']]), data, ('f3'))
minmaxscal((data[['f4']]), data, ('f4'))
minmaxscal((data[['f8']]), data, ('f8'))

minmaxscal((data[['f21']]), data, ('f21'))
minmaxscal((data[['f23']]), data, ('f23'))
minmaxscal((data[['f24']]), data, ('f24'))
minmaxscal((data[['f28']]), data, ('f28'))
data

minmaxscal((datasmote[['f1']]), datasmote, ('f1'))
minmaxscal((datasmote[['f3']]), datasmote, ('f3'))
minmaxscal((datasmote[['f4']]), datasmote, ('f4'))
minmaxscal((datasmote[['f8']]), datasmote, ('f8'))

minmaxscal((datasmote[['f21']]), datasmote, ('f21'))
minmaxscal((datasmote[['f23']]), datasmote, ('f23'))
minmaxscal((datasmote[['f24']]), datasmote, ('f24'))
minmaxscal((datasmote[['f28']]), datasmote, ('f28'))
datasmote

minmaxscal((datao[['f1o']]), datao, ('f1o'))
minmaxscal((datao[['f3o']]), datao, ('f3o'))
minmaxscal((datao[['f4o']]), datao, ('f4o'))
minmaxscal((datao[['f8o']]), datao, ('f8o'))

minmaxscal((datao[['f21o']]), datao, ('f21o'))
minmaxscal((datao[['f23o']]), datao, ('f23o'))
minmaxscal((datao[['f24o']]), datao, ('f24o'))
minmaxscal((datao[['f28o']]), datao, ('f28o'))
datao

minmaxscal((dataosmote[['f1o']]), dataosmote, ('f1o'))
minmaxscal((dataosmote[['f3o']]), dataosmote, ('f3o'))
minmaxscal((dataosmote[['f4o']]), dataosmote, ('f4o'))
minmaxscal((dataosmote[['f8o']]), dataosmote, ('f8o'))

minmaxscal((dataosmote[['f21o']]), dataosmote, ('f21o'))
minmaxscal((dataosmote[['f23o']]), dataosmote, ('f23o'))
minmaxscal((dataosmote[['f24o']]), dataosmote, ('f24o'))
minmaxscal((dataosmote[['f28o']]), dataosmote, ('f28o'))
dataosmote
